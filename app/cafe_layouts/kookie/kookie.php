...
<ol>
    ...
    <ol class="seats" type="A">
        ...
        <li class="counter">
            <label for="counter">Counter Table</label>
        </li>
        <li class="seat">
        </li>
    ...
    <li class="row row--10">
        ...
        <li class="seat">
            ...
            <li class="seat">
                <input type="checkbox" name="seats[]" value="9G" id="9G" />
                <label for="9G">9G</label>
            </li>
            <li class="seat">
                <input type="checkbox" name="seats[]" value="9H" id="9H" />
                <label for="9H">9H</label>
            </li>
            <li class="seat">
                <input type="checkbox" name="seats[]" value="9I" id="9I" />
    ...
    <ol class="seats" type="A">  
        ...
        <li class="long">
            <label for="long">Counter Table</label>
        </li>
        <li class="seat">
        </li>
        <li class="seat">
