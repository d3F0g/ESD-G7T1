...
9. Add CORS Plugin to your Konga GUI
9.1 For User_POST, Reviews_DELETE, Reviews_POST, Booking_POST routes
origin : *
...
10. The last step will be to access http://localhost/ESD-G7T1/app/facebook_login/login.php through your web browser and use our application!

10.1 You can log in to user account with, EMAIL: joqeewee@gmail.com, PW: root 
10.2 You can log in to admin account with, EMAIL: kindadopey@gmail.com, PW: root
10.3 If you would like to log in using Facebook, please get the credentials from our group as the Facebook login API is currently in development mode and will only allow the creator to test log in.  

10.4 Lolas and Kooks Cafe can be used for testing.  
